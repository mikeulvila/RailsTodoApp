...
describe TodoListsController do
  ...
  describe "GET show" do
    it "assigns the requested todo_list as @todo_list for logged in user" do
      todo_list = user_todo_lists.create! valid_attributes
  ...
  describe "GET new" do
    it "assigns a new todo_list as @todo_list for logged in user" do
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "does not allow user to create todo list for other users" do
